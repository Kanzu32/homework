...
// 6. (9 баллов) Используя структуру данных очередь, переписать содержимое текстового файла F в текстовый файл G,
//перенося при этом в конец каждой строки все входящие в нее цифры
//(с сохранением исходного взаимного порядка как среди цифр, так и среди остальных литер строки).
